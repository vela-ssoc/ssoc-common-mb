...
func newBrokerStat(db *gorm.DB, opts ...gen.DOOption) brokerStat {
	...
	_brokerStat.Timestamp = field.NewInt64(tableName, "timestamp")
	_brokerStat.Cgo = field.NewInt64(tableName, "cgo")
	_brokerStat.Goroutine = field.NewInt(tableName, "goroutine")
	_brokerStat.Alloc = field.NewUint64(tableName, "alloc")
	_brokerStat.Pause = field.NewUint64(tableName, "pause")
...
func (b *brokerStat) updateTableName(table string) *brokerStat {
	...
	b.Timestamp = field.NewInt64(table, "timestamp")
	b.Cgo = field.NewInt64(table, "cgo")
	b.Goroutine = field.NewInt(table, "goroutine")
	b.Alloc = field.NewUint64(table, "alloc")
	b.Pause = field.NewUint64(table, "pause")
...
func (b *brokerStat) fillFieldMap() {
	...
	b.fieldMap["cgo"] = b.Cgo
	b.fieldMap["goroutine"] = b.Goroutine
	b.fieldMap["alloc"] = b.Alloc
	b.fieldMap["pause"] = b.Pause
}
