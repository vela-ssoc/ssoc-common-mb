...
type SubstanceTask struct {
	...
	MinionID   int64     `json:"minion_id"   gorm:"column:minion_id;not null;comment:节点 ID"`
	Inet       string    `json:"inet"        gorm:"column:inet;not null;comment:节点 IP"`
	BrokerID   int64     `json:"broker_id"   gorm:"column:broker_id;not null;comment:节点所在的 broker_id"`
