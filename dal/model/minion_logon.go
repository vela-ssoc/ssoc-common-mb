...
type MinionLogon struct {
	...
	MinionID  int64     `json:"minion_id,string" gorm:"column:minion_id;index:idx_minion_id"`
	...
	CreatedAt time.Time `json:"created_at"       gorm:"column:created_at;notnull;default:now(3)"`
}
