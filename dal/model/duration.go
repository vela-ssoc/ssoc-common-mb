...
type Duration struct {
	...
	Hours   int `json:"hours"   validate:"gte=0,lte=23"` // A number of hours.
	Minutes int `json:"minutes" validate:"gte=0,lte=59"` // A number of minutes.
	Seconds int `json:"seconds" validate:"gte=0,lte=59"` // A number of seconds.
}
