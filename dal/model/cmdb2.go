...
type Cmdb2 struct {
	...
	OpDutyBackup            []*Cmdb2DutyMain `json:"op_duty.backup,omitempty"             gorm:"column:op_duty_backup;serializer:json"`
	OpDutyMain              []*Cmdb2DutyMain `json:"op_duty.main,omitempty"               gorm:"column:op_duty_main;serializer:json"`
	OpDutyStandby           []*Cmdb2DutyMain `json:"op_duty.standby,omitempty"            gorm:"column:op_duty_standby;serializer:json"`
	...
	RdDutyMain              []*Cmdb2DutyMain `json:"rd_duty.main,omitempty"               gorm:"column:rd_duty_main;serializer:json"`
	RdDutyMember            []*Cmdb2DutyMain `json:"rd_duty.member,omitempty"             gorm:"column:rd_duty_member;serializer:json"`
	...
	SysDuty                 []*Cmdb2DutyMain `json:"sys_duty,omitempty"                   gorm:"column:sys_duty;serializer:json"`
...
type Cmdb2OpDuty struct {
	Backup  []*Cmdb2DutyMain `json:"backup,omitempty"`
	Main    []*Cmdb2DutyMain `json:"main,omitempty"`
	Standby []*Cmdb2DutyMain `json:"standby,omitempty"`
}

type Cmdb2DutyMain struct {
